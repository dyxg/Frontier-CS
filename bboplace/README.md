...
This `bboplace/` directory is vendored from the upstream BBOPlace-Bench
repository:

- Upstream repository: https://github.com/lamda-bbo/BBOPlace-Bench
- Upstream commit: `4a0dde451e40a3f368e501df6f027c442fcca02a`
- Upstream license statement: the upstream README states that BBOPlace-Bench is
  licensed under the MIT License.

This copy includes the BBOPlace-Bench Python source and configuration needed by
the Frontier-CS Harbor adapter. It does not include benchmark datasets,
`thirdparty/`, or DREAMPlace source/build artifacts. Download benchmark data
